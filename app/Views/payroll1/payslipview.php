            ...
            <div class="col-md-12">
                <div class="">
                	<table width="100%">
                        <tr>
                            <td align="center">
                                <div style="margin-bottom: 15px"><img src="<?= base_url(); ?>/public/img/tmlogo.png" style="width: 70px;height: 70px; position: absolute;left:15px;" /></div>

                                <h1 style="margin: 0;"><?php echo "T.M Cargo & Logistics"; ?></h1>
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
                                <h5 style="padding: 5px"><?php echo"Address: M 1, Plot 152 Madar-e-Millat Road, Quaid-e-Azam Industrial Estate Quaid e Azam Industrial Estate, Lahore, Punjab 54000 Phone: 0309 7777228";?> </h5>
                            </td>
                        </tr>
                    
                        <tr>
                            <td align="center"><h2 style="margin: 10px 0 20px;"><?php echo "Payslip For the period of"; ?> <?php echo $result["month"] ?> <?php echo $result["year"] ?></h2></td>
                        </tr>
                    </table>
                    <table width="100%" class="paytable2">
                        <tr>
                            <th><?php echo 'Payslip'; ?> #<?php echo $result["id"] ?></th> <td></td>
                            <th class="text-right"></th> <th class="text-right"><?php echo 'Payment Date'; ?> : <?php

                               $date = strtotime($result['payment_date']);
                    ...
                    <table class="earntable table table-striped " >
                        ...
                        ?>
                        <tr>
                            <th><?php echo 'Total'; ?> <?php echo 'Earning'; ?></th>
                            <th class="pttright reborder"><?php echo $result["total_allowance"] ?></th>
                            <th class="pttleft"><?php echo 'Total'; ?> <?php echo 'Deduction'; ?></th>
                            <th class="text-right"><?php echo $result["total_deduction"] ?></th>
                        </tr>  
                    </table>   
                    <table class="totaltable table table-striped ">
                        <tr>
...
<?php if (!empty($result["tax"])) { ?>
                            <tr>
                                <th width="20%"><?php echo 'Tax'; ?></th> 
                                <td><?php echo $result["tax"] ?></td>
                            </tr>
                        <?php }
                        ?>
                        <tr>
                            <th width="20%"><?php echo 'Net Salary'; ?></th> 
                            <td><?php echo $result["net_salary"] ?></td>
                        </tr>
                    </table>  
                    <p class="ptt10"><?php echo 'This payslip is computer generated hence no signature is required.'; ?></p>
                </div>
            </div>
            <!--/.col (left) -->
        </div>
